...
3. `Confirm` (`szc:<qid>:<outcome>:<total>`) shows a **confirmation screen** (the
   ...
   since the game already lives in the `GamesKey` map; see the bet-games section.
